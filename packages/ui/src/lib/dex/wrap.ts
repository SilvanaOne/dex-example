...
import { MinaSignature, Operation } from "./types";
...
export async function wrapMinaSignature(params: {
  ...
  let suiData = new Uint8Array([
    ...
    ...bcs
      .u256()
      .serialize(await publicKeyToU256(poolPublicKey))
      .toBytes(),
    ...bcs.u8().serialize(operation).toBytes(),
    ...bcs
      .u256()
      .serialize(await publicKeyToU256(minaPublicKey))
      .toBytes(),
  ...
  if (receiverPublicKey !== undefined) {
    suiData = new Uint8Array([
      ...
      ...bcs
        .u256()
        .serialize(await publicKeyToU256(receiverPublicKey))
        .toBytes(),
    ]);
  }
